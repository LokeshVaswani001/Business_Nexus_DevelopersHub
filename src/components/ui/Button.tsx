...
export const Button: React.FC<ButtonProps> = ({
  ...
  // ✅ FIX: text-current added
  const baseStyles =
    'inline-flex items-center justify-center font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 text-current';
  ...
  const variantStyles = {
    ...
    outline:
      'border border-gray-300 bg-white text-gray-900 hover:bg-gray-100 focus:ring-primary-500',
    ghost:
